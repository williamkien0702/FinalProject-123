...
MonoBehaviour:
  ...
  m_PixelRect:
    ...
    height: 552
  m_ShowMode: 2
  m_Title: Player 2 (Client And Server)
  m_RootView: {fileID: 2}
...
MonoBehaviour:
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {fileID: 15020, guid: 0000000000000000e000000000000000, type: 0}
  m_Name: 
  m_EditorClassIdentifier: UnityEditor.MultiplayerModule.dll::Unity.Multiplayer.PlayMode.Editor.TopView
  m_MinSize: {x: 50, y: 50}
  m_MaxSize: {x: 4000, y: 4000}
  m_TitleContent:
    m_Text: Unity.Multiplayer.PlayMode.Editor.TopView
    m_Image: {fileID: 0}
    m_Tooltip: 
    m_TextWithWhitespace: "Unity.Multiplayer.PlayMode.Editor.TopView\u200B"
  m_Pos:
    serializedVersion: 2
    x: 637
    y: 194
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1750, y: 470}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
